    ...
    <>
      ...
      {modalTransition((style, item) =>
        item && (
          ...
          >
            <div className="bg-neutral-900 select-none rounded-lg w-full max-w-sm border border-neutral-800 shadow-2xl">
              ...
              <div className="p-4 max-h-[70vh] overflow-y-auto">
                {beat && (
                  <div className="space-y-3">
                    ...
                    {beat.terms_of_use && (
                      <div>
                        <h4 className="text-white font-medium mb-2 text-sm">Условия использования:</h4>
                        <div className="space-y-1">
                          {Object.entries(beat.terms_of_use).map(([key, value]) => (
                            value && (
                              <div key={key} className="flex items-center text-neutral-300 text-sm">
                          ...
                          {!Object.values(beat.terms_of_use).some(v => v) && (
                            <p className="text-neutral-500 text-xs">Условия использования не указаны</p>
                          )}
                        </div>
                      </div>
                    )}
