    ...
    const faqItems = [
        {
            ...
            answer: "Используйте функцию 'Забыли пароль' на странице входа. Если не получается, или мы ещё не придумали эту функцию, напишите нам с почты, указанной при регистрации."
        },
        {
            question: "Как изменить email?",
            answer: "Email можно изменить в настройках профиля."
        },
        {
        ...
        },
        {
            ...
            answer: "В настройках профиля внизу страницы потом будет раздел короче 'Удаление аккаунта'."
        }
    ];
